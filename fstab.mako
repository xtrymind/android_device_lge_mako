...
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           f2fs    noatime,nosuid,nodev,discard,nodiratime,inline_xattr,errors=recover    wait,nonremovable,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
